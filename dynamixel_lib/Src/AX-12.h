...
//biblioteka moze dziala, moze dziala tez dla innych dynamixeli

#include "stm32f4xx_hal.h"


//na uk³adzie max3485 jest pin okreslajacy w ktora strone odbywa sie transmisja
//chyba w naszych ukladach stan wysoki to transmisja stm -> dynamixel
//trzeba podpiac do pinu na stm, np 9a
